...
Nov2009Char<-read.csv("EgyptNov2009RTTComplete.csv", colClasses="character")
NOv2009DF<-dataConverter(Nov2009Char)
meanRTTNov2009 <- mean(Nov2009DF$RTT)
plotter(Nov2009DF)
Dec2009Char<-read.csv("Egypt2009DecRTTComplete.csv", colClasses="character")
Dec2009DF<-plotRTTData(Dec2009Char)
meanRTTDec2009 <- mean(Dec2009DF$RTT)
Jan2010Char<-read.csv("Egypt2010JanRTTComplete.csv", colClasses="character")
Jan2010DF<-plotRTTData(Jan2010Char)
meanRTTJan2010 <- mean(Jan2010DF$RTT)
Feb2010Char<-read.csv("Egypt2010FebRTTComplete.csv", colClasses="character")
Feb2010DF<-plotRTTData(Feb2010Char)
meanRTTFeb2010 <- mean(Feb2010DF$RTT)

Mar2010Char<-read.csv("Egypt2010MarRTTComplete", colClasses="character")
Mar2010DF<-plotRTTData(Mar2010Char)
meanRTTMar2010 <- mean(Mar2010DF$RTT)
Apr2010Char<-read.csv("Egypt2010AprRTTComplete.csv", colClasses="character")
Apr2010DF<-plotRTTData(Apr2010Char)
meanRTTApr2010 <- mean(Apr2010DF$RTT)
May2010Char<-read.csv("Egypt2010MayRTTComplete.csv", colClasses="character")
May2010DF<-plotRTTData(May2010Char)
meanRTTMay2010 <- mean(May2010DF$RTT)
June2010Char<-read.csv("June2010.csv", colClasses="character")
June2010DF<-plotRTTData(June2010Char)
meanRTTJune2010 <- mean(June2010DF$RTT)
Jul2010Char<-read.csv("Egypt2010JulyRTTComplete.csv", colClasses="character")
Jul2010DF<-plotRTTData(Jul2010Char)
meanRTTJul2010 <- mean(Jul2010DF$RTT)

Aug2010Char<-read.csv("Egypt2010AugRTTComplete.csv", colClasses="character")
Aug2010DF<-plotRTTData(Aug2010Char)
meanRTTAug2010 <- mean(Aug2010DF$RTT)
Sep2010Char<-read.csv("Egypt2010SeptRTComplete.csv", colClasses="character")
Sep2010DF<-plotRTTData(Sep2010Char)
meanRTTSep2010<-mean(Sep2010DF$RTT)
Oct2010Char<-read.csv("Egypt2010OctRTComplete.csv", colClasses="character")
Oct2010DF<-plotRTTData(Oct2010Char)
meanRTTOct2010<-mean(Oct2010DF$RTT)
Nov2010Char <-read.csv("Egypt2010NovRTTComplete.csv", colClasses="character")
Nov2010DF <-  plotRTTData(Nov2010Char)
meanRTTNov2010 <- mean(Nov2010DF$RTT)
Dec2010Char <- read.csv("Egypt2010DecRTTComplete.csv", colClasses="character") 
Dec2010DF <- plotRTTData(Dec2010Char)
meanRTTDec2010<-mean(Dec2010DF$RTT)

Jan2011Char <- read.csv("Egypt2011JanRTTComplete.csv", colClasses="character") 
Jan2011DF <-  plotRTTData(Jan2011Char)
meanRTTJan2011<-mean(Jan2011DF$RTT)
Feb2011Char <- read.csv("Egypt2011FebRTTComplete.csv", colClasses="character") 
Feb2011DF <-  plotRTTData(Feb2011Char)
meanRTTFeb2011 <-mean(Feb2011DF$RTT)
Mar2011Char <- read.csv("Egypt2011MarRTTComplete.csv", colClasses="character") 
Mar2011DF <-  plotRTTData(Mar2011Char)
meanRTTMar2011<-mean(Mar2011DF$RTT)
Apr2011Char <- read.csv("Egypt2011AprRTTComplete.csv", colClasses="character") 
